...
class Attendance:
    def __init__(self,root):
        ...
        #image1
        img=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/attendance1.jpg")
        ...
        #image2
        img1=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images /attendance2.jpg")
        ...
        #bgimage
        img3=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/backg2.jfif")
        ...
        title_lbl=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="red")
        title_lbl.place(x=0,y=0,width=1400,height=45)

        main_frame=Frame(bg_img,bd=2,bg="white")
        main_frame.place(x=5,y=55,width=1260,height=428)

        #left label frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Attendance Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=5,y=5,width=670,height=415)

        #left image
        img_left=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/attendance.jpg")
        ...
        left_inside_frame.place(x=5,y=125,width=650,height=260)
        ...
        timeLabel.grid(row=0,column=2,padx=4,pady=8)
        ...
        self.atten_status.grid(row=2,column=1,pady=8)
        self.atten_status.current(0)

        #buttonsframe
        btn_frame=Frame(left_inside_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame.place(x=95,y=160,width=410,height=80)
        ...
        Right_frame.place(x=685,y=5,width=570,height=415) 

        table_frame=Frame(Right_frame,bd=2,relief=RIDGE,bg="white")
        table_frame.place(x=5,y=5,width=550,height=380)
