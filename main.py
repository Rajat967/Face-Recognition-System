...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\gu.jpg")
        ...
        img1=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\face_recog_3.png")
        ...
        img2=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\face_rec_1.jpg")
        ...
        title_lb.place(x=-2,y=0,width=1340,height=50)


        #Student Button
        std_1=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\std_1.jpg")
        ...
        #Detect Face
        face_1=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\face_detect.jpg")
        ...
        b1.place(x=400,y=100,width =220,height=160)

        b1_txt=Button(bg_image,text="Face Recognizer",command=self.face_data,cursor="hand2",font=("PT Serif",15,"bold"),bg="#040229",fg="white")
        b1_txt.place(x=400,y=260,width =220,height=40)



        #Attendance 
        att=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\att.png")
        ...
        #Help Desk
        help=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\help_d.jpg")
        ...
        #Training the algo
        train=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\training.jpg")
        ...
        #Data library
        photos=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\store.jpg")
        ...
        Dev=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\dev1.jpg")
        ...
        #Exit Button
        Exit=Image.open("C:\\Users\\rajat\\OneDrive\\Desktop\\SmartAttendance-main\\SmartAttendance-main\\Images\\exit.png")
...
#############################Function buttons ###################
    ...
    def open_img(self):
        os.startfile("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/data")
