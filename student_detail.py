...
class Student:
    def __init__(self,root):
        ...
        img=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/students.jpg")
        ...
        img1=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/facere.jpg")
        ...
        first_lb.place(x=500,y=0,width=450,height=130)


        img2=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/stdents2.jpg")
        img2=img2.resize((530,130),Image.LANCZOS)   #High level img to Low level img
        self.photoimg2=ImageTk.PhotoImage(img2)

        first_lb=Label(self.root, image=self.photoimg2)
        first_lb.place(x=900,y=0,width=530,height=130)

        #Bg Image
        bg=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/backg2.jfif")
        ...
        bg_image.place(x=0,y=130,width=1330,height=560)
        ...
        left_frame.place(x=10,y=10,width=680,height=485)
        ...
        current_course_frame.place(x=10,y=15,width=660,height=120)
        ...
        class_student_frame.place(x=10,y=150,width=660,height=305)
        
        # Student Id
        studentId_label=Label(class_student_frame,text="Student ID:",font=("time new roman",12,"bold"),bg="#f0ecdf")
        studentId_label.grid(row=0,column=0,padx=8,pady=5,sticky=W)

        studentID_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_id,width=17,font=("time new roman",12,"bold"))
        ...
        studentName_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_name,width=17,font=("time new roman",12,"bold"))
        ...
        studentEmail_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_email,width=17,font=("time new roman",12,"bold"))
        ...
        studentGender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_gender,width=15,state="readonly",font=("time new roman",12,"bold"))
        ...
        PhoneNo_entry=ttk.Entry(class_student_frame,textvariable=self.var_phone_no,width=17,font=("time new roman",12,"bold"))
        ...
        address_entry=ttk.Entry(class_student_frame,textvariable=self.var_add,width=17,font=("time new roman",12,"bold"))
        ...
        Father_Gardian_Name=ttk.Entry(class_student_frame,textvariable=self.var_ForG,width=17,font=("time new roman",12,"bold"))
        ...
        DOB=ttk.Entry(class_student_frame,textvariable=self.var_dob,width=17,font=("time new roman",12,"bold"))
        DOB.grid(row=3,column=3,padx=10,pady=5,sticky=W)
       
        # Eno
        Eno=Label(class_student_frame,text="Enroll NO:",font=("time new roman",12,"bold"),bg="#f0ecdf")
        Eno.grid(row=4,column=0,padx=10,pady=5,sticky=W)

        Eno=ttk.Entry(class_student_frame,textvariable=self.var_roll,width=17,font=("time new roman",12,"bold"))
        Eno.grid(row=4,column=1,padx=10,pady=5,sticky=W)
       
       
        # Teacher
        Mentor=Label(class_student_frame,text="Teacher:",font=("time new roman",12,"bold"),bg="#f0ecdf")
        Mentor.grid(row=4,column=2,padx=10,pady=5,sticky=W)

        Mentor=ttk.Entry(class_student_frame,textvariable=self.var_mentor,width=17,font=("time new roman",12,"bold"))
       ...
       #  Button Frame
        ...
        btn_frame.place(x=10,y=210,width=600,height=45)
        #Save btn
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=12,font=("time new roman",12,"bold"),bg="grey",fg="white")
        save_btn.grid(row=0,column=0,padx=10,pady=5)

        #Update btn
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=12,font=("time new roman",12,"bold"),bg="grey",fg="white")
        update_btn.grid(row=0,column=1,padx=5,pady=5)

        #Delete btn
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=12,font=("time new roman",12,"bold"),bg="grey",fg="white")
        delete_btn.grid(row=0,column=2,padx=5,pady=5)

        #Reset btn
        Reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=12,font=("time new roman",12,"bold"),bg="grey",fg="white")
        Reset_btn.grid(row=0,column=3,padx=10,pady=5)

        # Second Button Frame
        btn_frame_2=LabelFrame(class_student_frame,bd=2,bg="#f0ecdf",relief=RIDGE)
        btn_frame_2.place(x=10,y=248,width=600,height=35)

        #take photo btn
        take_photo_btn=Button(btn_frame_2,text="Take Photo",command=self.generate_dataset,width=55,font=("time new roman",12,"bold"),bg="grey",fg="white")
        ...
        right_frame.place(x=700,y=10,width=550,height=485)
        ...
        search_frame.place(x=5,y=15,width=535,height=70)

        Search=Label(search_frame,text="Search By:",font=("time new roman",11,"bold"),bg="#f0ecdf",fg="dark blue")
        Search.grid(row=0,column=0,padx=7,pady=5,sticky=W)

        search_combo=ttk.Combobox(search_frame,font=("time new roman",12,"bold"),state="readonly",width=10)
        ...
        search_entry=ttk.Entry(search_frame,width=11,font=("time new roman",11,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=3,sticky=W)

        search_btn=Button(search_frame,text="Search",width=8,font=("time new roman",11,"bold"),bg="grey",fg="white")
        search_btn.grid(row=0,column=3,padx=3)
        
        showAll_btn=Button(search_frame,text="Show All",width=8,font=("time new roman",11,"bold"),bg="grey",fg="white")
        showAll_btn.grid(row=0,column=4,padx=3)

        #Table Frame

        Table_frame=Frame(right_frame,bd=2,bg="#f0ecdf",relief=RIDGE)
        Table_frame.place(x=5,y=105,width=535,height=350)

        scroll_x=ttk.Scrollbar(Table_frame,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(Table_frame,orient=VERTICAL)

        self.student_table=ttk.Treeview(Table_frame,column=("dep","course","year","sem","Student_ID","Student_Name","Student_Email","Gender","Phone_no","Address","Name(F/G)","D.O.B","Teacher","Photo","Enrollment_No"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
######################################## updarte functiom #########################################
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_sem.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_std_email.get()=="" or self.var_gender.get()=="Select Gender" or self.var_dob.get()=="" or self.var_ForG.get()=="" or self.var_add.get()=="" or self.var_phone_no.get()==""  or self.var_mentor.get()=="":
            messagebox.showerror("Error","All fields are required",parent=self.root)
        else:
            try:
                ...
                if(update>0):
                    conn=mysql.connector.connect(host='localhost',user='root',password='12345',database='face_recognition')
                    my_cursor=conn.cursor()
                    sql="""UPDATE student_detail SET dep= %s,course= %s,year= %s,semester= %s,name= %s,email= %s,gender= %s,phone= %s, address= %s,guardian=%s, dob= %s,teacher=%s,photosample= %s,eno=%s where student_id= %s"""
                    val=(
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
...
####### generate dataset or take photos  #####
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_sem.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_std_email.get()=="" or self.var_gender.get()=="Select Gender" or self.var_dob.get()=="" or self.var_ForG.get()=="" or self.var_add.get()=="" or self.var_phone_no.get()=="" or self.var_mentor.get()=="" or self.var_roll.get()=="":
            messagebox.showerror("Error","All fields are required",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host='localhost',user='root',password='12345',database='face_recognition')
                ...
                harcascadePath = "C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Cascades/haarcascade_frontalface_default.xml"
                ...
                while(True):
                    ...
                    for(x,y,w,h) in faces:
                        ...
                        cv2.imwrite("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/data/image." + str(id) + '.' +
