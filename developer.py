...
class Developer:
    def __init__(self,root):
        ...
        img_top=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/dev.jpg")
        ...
        img_l=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/developergif.gif")
        ...
        first_lb.place(x=300,y=0,width=200,height=200)
         ...
         # Developer Info
        dev_lb=Label(main_frame,text="Rajat Rawat\n BTECH(CSAI-3rd year)",font=("time new roman",15,"bold"),bg="white",fg="#142552")
