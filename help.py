...
class Help:
    def __init__(self,root):
        ...
        img_top=Image.open("C:/Users/rajat/OneDrive/Desktop/SmartAttendance-main/SmartAttendance-main/Images/help_d.jpg")
        ...
        help_lb=Label(first_lb,text="Name:RAJAT RAWAT ",font=("time new roman",15,"bold"),fg="white",bg="black")
        help_lb.place(x=1000,y=65)

        help_lb2=Label(first_lb,text="email:rajatrawat572@gmail.com",font=("time new roman",15,"bold"),fg="white",bg="black")
        help_lb2.place(x=1000,y=145)

        help_lb3=Label(first_lb,text="contact:8221864214",font=("time new roman",15,"bold"),fg="white",bg="black")
